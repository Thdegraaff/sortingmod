...
Due to likely correlation between prices and unobserved characteristics, it is necessary to estimate the sorting model in two steps.(See discussion in Berry et al. (1995)).
...
## Second step
The second step of the estimation involves estimating the equation: 
...
Since prices are likely to be correlated with the error term $\xi_j$ the second step estimation follows a two stage least squares (2SLS) procedure to account for this endogeneity problem.
